...
# combination plot
@app.route(f'{url_base}{version}combination_data/<string:endpoint_name>',methods=['GET'])
@cross_origin()
def get_combination_graph_data(endpoint_name):
    success,data = flask.returnDataCombinationPlot(endpoint_name)
    print("data:")
    print(data)
